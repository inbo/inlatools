...
run <- interactive() || 
  ...
  !file.exists("prior_random_walk.Rda")
if (!run) {
  load("prior_random_walk.Rda")
}
```
...
```{r save_eval, eval = run, echo = FALSE}
save(
  rw1, rw1_c, rw1_d, rw1_q, rw1_s1, rw1_s2, rw1_s3, rw2, 
  file = "prior_random_walk.Rda"
)
```
